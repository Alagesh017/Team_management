...
@token_required
def create_task_status_route(decoded_payload):
    return create_task_status(decoded_payload)

@task_status_bp.route("/", methods=["GET"])
@token_required
def get_task_statuses_route(decoded_payload):
